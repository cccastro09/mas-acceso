...
<!Doctype html>
 ...
 <link rel="stylesheet" href="../../css/login.css">
	 ...
	 <a href="../../Login/index.php">+ACCESO</a>     
	 <div class="container">
        <table>
          <?php
            ...
            foreach ($UsuarioObj->consultarUsuario() as $c) {
                ?>
                     ...
                     <tr>
					  ...
					  <td><a class="boton azul" href="editarUsuario.php?id=<?php echo $c->getId();?>">Editar</a></td>
                      <td><a class="boton azul" href="eliminar.php?id=<?php echo $c->getId();?>">Eliminar</a></td>
                     </tr>
                   <?php
            }
            ?>
          ...
          <tr>
             <td colspan=14><a class="boton azul" href="../index.php">Crear Usuario</a></td>
          </tr>
