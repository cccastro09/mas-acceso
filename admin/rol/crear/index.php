...
if (isset($_POST["nombre"])) {
    $vCollector = new ColectorRol();
    $rol = new RolClass();
    $rol->setNombre($_POST["nombre"]);
    $rol->setConstante($_POST["constante"]);
    if ($vCollector->addRol($rol)) {
        //var_dump($obj);
        header("Location: /admin/rol/");
        exit();
    } else {
        echo "Hubo un error al intentar agregar el rol.";
    }
} else {
?>
<!DOCTYPE html>
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                      <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <input class='form-control' placeholder='constante' name="constante" id="constante" rows="6"></input>
                        </div>
